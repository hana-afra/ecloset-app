...
class Tops extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shopProvider = Provider.of<ShopTop>(context);

    return FutureBuilder<void>(
      future: shopProvider.fetchTops(context),
      builder: (context, snapshot) {
        if (shopProvider.shoptop.isNotEmpty) {
          // Access the products
          final products = shopProvider.shoptop;
