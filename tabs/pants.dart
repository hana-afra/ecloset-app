...
class Pants extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shopProvider = Provider.of<ShopPants>(context);

    return FutureBuilder<void>(
      future: shopProvider.fetchPants(context),
      builder: (context, snapshot) {
        if (shopProvider.shoppants.isNotEmpty) {
          // Access the products
          final products = shopProvider.shoppants;
